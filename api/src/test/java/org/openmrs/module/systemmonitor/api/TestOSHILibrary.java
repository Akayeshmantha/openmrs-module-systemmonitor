 ...
 * @author k-joseph
 * 
 * Tests Library: https://github.com/dblock/ (Operating System and Hardware Information): A JNA-based (native) operating system information library for Java that aims to provide a cross-platform implementation to retrieve system information, such as version, memory, CPU, disk, battery, etc.
 *	
 * @TODO Re-write a version of this library that supports lower java version instead of requiring 1.8
 */
public class TestOSHILibrary {
	...
	public void test_systemMemoryUsage() {
        ...
        System.out.println("\n::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::\nTOTAL MEMORY (Bytes): " + memory.getTotal());
	...
	@Test
	public void test_systemNetwork() {
		SystemInfo si = new SystemInfo();
	...
	public void test_systemPowerUsage() {
        ...
        for (PowerSource ps : psArr) {
            ...
            System.out.println("\n::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::\nPOWER-REMAINING CAPACITY: " + ps.getRemainingCapacity());
